...
const SystemTray = () => {
  ...
  return (
    <div className='flex select-none items-center gap-[3px]'>
      {/* Quick settings */}
      <button
        className='flex cursor-default items-center gap-1.5 rounded px-2 text-right text-xs hover:bg-white/90'
      ...
      <Tooltip delayDuration={1000}>
        <TooltipTrigger asChild>
          <button
            ...
            className='cursor-default rounded py-1 pl-2 pr-2 text-right text-xs hover:bg-white/90'
            data-id='calendar'
          >
